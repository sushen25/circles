 ...
 *
 * The organiser gives the plan to another active member with a saved place.
 * Refusals: `not_the_organiser`, `requires_saved_place` (a guest),
 * `not_a_member` (not in the circle, or not any more), `already_the_organiser`,
