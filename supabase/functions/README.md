...
| [`hand-off-organiser/`](./hand-off-organiser)             | "Hand this to someone else": the plan to another saved-place member, and the old organiser's queued letters taken back (§5.7)                                                                             |
