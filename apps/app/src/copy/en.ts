...
export const en = {
  ...
  account: {
    ...
    notifications_detail: 'What we send you, circle by circle',
    row_label: '{title}. {detail}',
    loading: 'Getting your account',
    couldnt_load: "We couldn't load your account.",
    youre_offline: "You're offline. Connect, then try again.",
    try_again: 'Try again',
    name_title: 'What friends call you',
    name_hint: 'Shown to everyone in your circles.',
    save: 'Save',
    saving: 'Saving…',
    name_unusable: 'A name needs a letter or two, and at most 40 characters.',
  ...
  addToCalendar: {
    /**
     * The sheet over either confirmed screen (spec §5.7). The Google Calendar
     * row is held to Slice 3 (founder decision), so it has no words here yet.
     */
    title: 'Add {day} to your calendar',
    detail: '{day}, {time}',
  ...
  availability: {
    ...
    duration_300: '5 hours',
    times_in_zone: 'Times are {zone} time.',
    days_group: 'Days in this plan',
    day_with_times: '{day}, {time}',
    day_no_times: '{day}, no times yet',
    tag_morning: 'Morn',
    tag_afternoon: 'Aft',
    tag_evening: 'Eve',
    tag_any_time: 'Any',
    tag_from_now: 'Now',
    tag_later_tonight: 'Late',
    tag_some: 'Some',
    pick_days: 'Tap every day that could work. Then pick a time once, for all of them.',
    ...
    my_answer: 'My answer',
    nothing_yet: 'Nothing yet. Your days and times will be listed here in words.',
    adjust_day: '{day}, {time}. Adjust by the half hour',
    any_time_that_day: 'Any time that day',
    clear_this_day: 'Clear this day',
    any_time_on: 'Any time on {day}',
    clear_day: 'Clear {day}',
    remove_day: 'Remove day',
    remove_day_on: 'Remove {day}',
  ...
  cancelPlan: {
    ...
    keep_it: 'Keep it',
    title_day: "Cancel {day}'s catch-up?",
    title_plain: 'Cancel this catch-up?',
    body_asking:
      "Everyone will see it's off, and the answers so far are set aside. The circle's record isn't changed, and you can plan another any time.",
    note_hint: 'Up to 280 characters. Everyone in the circle sees it.',
    note_count: '{count} of {total}',
    cancelling: 'Cancelling',
    not_yours: "Only the organiser or the circle's owner can cancel this plan.",
  },
  cancelledGuest: {
    sunday_crew: 'Sunday Crew',
    brand: '{brand}',
    ...
    headline_day: "{day}'s catch-up is off.",
    headline_plain: 'The catch-up is off.',
    body: "It's been called off. Nothing you sent has been shared, and the circle's record isn't affected.",
    body_named:
      "{name} cancelled it. Nothing you sent has been shared, and the circle's record isn't affected.",
    note_label: 'The note with it',
    note_label_named: "{name}'s note",
    note: '“{detail}”',
  ...
  cancelledOrg: {
    ...
    headline_day: "{day}'s catch-up is off.",
    headline_plain: 'The catch-up is off.',
    body: "Everyone in {circle} will see it's off. The circle's last-caught-up date is unchanged.",
  ...
  candidates: {
    /**
     * The card vocabulary, read from here by the member and no-quorum screens
     * too: the same option is described on three screens, and three copies of
     * "Best attendance" is one copy that will drift.
     */
    someone: 'Someone',
    times_in_zone: 'Times are {zone} time.',
    replied: '{count} of {total} replied',
    asked_label: '{count} people were asked',
    closes: 'Closes {deadline}',
    replies_closed: 'Replies closed',
    count: '{count} of {total}',
    nobody_free: 'Nobody was free',
    rank_best_attendance: 'Best attendance',
    rank_same_weekend: 'Same {count}, weekend',
    rank_same_sooner: 'Same {count}, sooner',
    rank_same_later: 'Same {count}, later',
    rank_one_fewer_weekend: 'One fewer, weekend',
    rank_one_fewer_sooner: 'One fewer, sooner',
    rank_one_fewer_later: 'One fewer, later',
    rank_also_sooner: 'Also {count}, sooner',
    rank_also_later: 'Also {count}, later',
    rank_closest: 'Closest',
    not_one: "Doesn't work for {name}",
    not_two: "Doesn't work for {name} or {other}",
    not_three: 'Not {name}, {other} or {third}',
    not_many: 'Not {name}, {other} and {count} others',
    waiting_one: "{name} hasn't answered",
    waiting_two: "{name} and {other} haven't answered",
    ...
    can_many: '{name}, {other} and {count} others can make it',
    can_nobody: 'Nobody can make this one',
    list_one: '{name}',
    list_two: '{name} and {other}',
    list_three: '{name}, {other} and {third}',
    list_many: '{name}, {other} and {count} others',
    you: 'you',
    ...
    lead_three:
      '{name}, {other} and {third} are still to answer. You can lock a time in now, or wait until {deadline}.',
    lead_many:
      '{count} people are still to answer. You can lock a time in now, or wait until {deadline}.',
    review: 'Review {day}',
    nudge_one: 'Nudge {name}',
    nudge_two: 'Nudge {name} and {other}',
    nudge_three: 'Nudge {name}, {other} and {third}',
    nudge_many: 'Nudge {count} people',
    updating: 'Someone just answered. Getting the options again.',
    loading: 'Getting the options',
    couldnt_load: "We couldn't load the options.",
    youre_offline: "You're offline. Connect, then try again.",
    try_again: 'Try again',
  ...
  candidatesMember: {
    lead_organiser:
      '{name} picks one of these once replies close. You can change your times until then.',
    lead_no_organiser:
      'One of these gets picked once replies close. You can change your times until then.',
    change_my_times: 'Change my times',
    closed_note: 'Replies have closed, so times can no longer change.',
    lead_closed_organiser: 'Replies have closed. {name} picks one of these.',
    lead_closed_no_organiser: 'Replies have closed. One of these gets picked next.',
    no_overlap_closed_body: 'Replies have closed and nothing is decided yet.',
    waiting_headline: 'Waiting on a few more.',
    waiting_body: 'Options appear once {count} people can make the same time.',
    no_overlap_headline: "There wasn't enough overlap this time.",
    no_overlap_body: 'Nothing is decided yet. Changing your times is the quickest way to help.',
    loading: 'Getting the options',
    couldnt_load: "We couldn't load the options.",
    youre_offline: "You're offline. Connect, then try again.",
    try_again: 'Try again',
  ...
  changeTime: {
    ...
    body_day:
      '{day} will be marked as no longer happening, and everyone will be asked for their times again.',
    warn_day:
    ...
    not_locked_in_body:
      "There's no time to change yet. Edit the plan instead, while everyone's still answering.",
  },
  checkEmail: {
  ...
  circleHome: {
    ...
    about_weekly: 'about weekly',
    about_fortnightly: 'about fortnightly',
    about_monthly: 'about monthly',
    about_every_two_months: 'about every two months',
    no_goal_set: 'No goal set',
    members: '{count} members · {what}',
    one_member: '1 member · {what}',
    ...
    up_to_you: 'Up to you',
    due_soon: 'Due soon',
    loading: 'Getting your circle',
    couldnt_load: "We couldn't load this circle.",
    youre_offline: "You're offline. Connect, then try again.",
    try_again: 'Try again',
    ...
    period_fortnightly: 'about a fortnight',
    period_monthly: 'about a month',
    period_two_monthly: 'about two months',
    going: '{going} going',
    going_to_confirm: '{going} going · {count} to confirm',
  ...
  circleHomeConfirmed: {
    ...
    couldnt_copy: "Couldn't copy the message. Try again.",
  },
  circleHomeDue: {
    sunday_crew: 'Sunday Crew',
    '6_members_about_monthly': '6 members · about monthly',
  ...
  circleHomeJoining: {
    ...
    plan_a_catch_up: 'Plan a catch-up',
    in_so_far: '{count} in so far · {what}',
    one_just_joined: '{name} just joined',
    two_just_joined: '{name} and {other} just joined',
    many_just_joined: '{name} and {count} others just joined',
    nobody_yet: "Nobody's joined yet. Share the link in your group chat.",
  },
  circlesList: {
    ...
    account: 'Account',
    finding_a_time_replied: 'Finding a time · {count} of {total} replied',
    locked_in_on: 'Locked in · {date}',
    last_caught_up_on: 'Last caught up {date} · {next}',
    no_rush: 'No rush',
    due_soon: 'Due soon',
    no_goal_set: 'No goal set',
    about_time: 'About time for the next one',
    not_caught_up_yet: 'Not caught up yet',
    just_you: 'Just you so far',
    archived: 'Archived',
    row_label: '{name}. {line}',
    loading: 'Getting your circles',
    couldnt_load: "We couldn't load your circles.",
  ...
  confirmReview: {
    ...
    summary: '{count} of {total} can make it',
    summary_with: '{count} of {total} can make it · {first}',
    where: 'Where',
    place_name: 'Place, optional',
    place_name_label: 'Where it is',
    place_url: 'Map link, optional',
    place_url_label: 'A map link for the place',
    place_url_invalid: 'That needs to be a link starting with https://. Or leave it empty.',
    a_note_for_everyone: 'A note for everyone',
    note_placeholder: 'Anything people should know. Optional.',
    note_count: '{count} of {total}',
    chase_question: 'Did you have to chase anyone outside the app?',
    chase_none: 'No',
    ...
    warn_three:
      "{name}, {other} and {third} haven't replied. They'll see the plan and can say whether they're coming.",
    warn_many:
      "{name}, {other} and {count} others haven't replied. They'll see the plan and can say whether they're coming.",
    lock_it_in_2: 'Lock it in',
    locking: 'Locking it in',
    times_are_frozen_once_locked_later_replies:
      "Times are frozen once locked. Later replies won't move it.",
    updating: 'Someone just answered. Getting the latest before you lock it in.',
    moved:
      'Someone answered while you were looking, so this is updated. Check it, then lock it in.',
    gone_title: "That time isn't one of the options any more.",
    gone_body: 'An answer changed what works. The options have the times that do now.',
    none_title: 'There is nothing to lock in yet.',
    none_body: 'A time shows up in the options once it works for enough people.',
    stopped_title: 'This plan is not picking a time any more.',
    stopped_body: 'It was called off or ran out of time. The circle has the rest.',
    passed: 'That time has already started. Pick another from the options.',
    not_organiser_title: 'Only the organiser locks a time in.',
    not_organiser_body: 'You can see the options and change your own times.',
    already: 'This plan is already locked in.',
  ...
  confirmedGuest: {
    ...
    names_line: '{first} · {second}',
    to_confirm_names: '{name} to confirm',
    going_names: '{name} going',
    youre_going: "You're going",
    you_cant: "You can't make it",
    you_unsaid: 'Are you coming?',
    ...
    i_cant_make_it: "I can't make it",
    saving: 'Saving',
    refused: "That can't be changed now. The meetup may have moved or finished.",
    problem: "That didn't save. Try again.",
    youre_offline: "You're offline. Connect, then try again.",
  },
  confirmedGuestNudge: {
  ...
  confirmedOrg: {
    /**
     * The one screen the manifesto lets be warm (§3.7). The shared parts of
     * both confirmed screens live here and the guest's read them too — "Locked
     * in" and the counts are one sentence on two screens.
     */
    locked_in: 'Locked in',
    time_place: '{time} · {what}',
    ready_to_paste_into_the_group_chat: 'Ready to paste into the group chat',
    going: '{count} going',
    cant: "{count} can't make it",
    to_confirm: '{count} to confirm',
    unsaid_one: "{name} hasn't said yet",
    unsaid_two: "{name} and {other} haven't said yet",
    unsaid_three: "{name}, {other} and {third} haven't said yet",
    unsaid_many: "{name}, {other} and {count} others haven't said yet",
    everyone_said: 'Everyone has said',
    share_to_group_chat: 'Share to group chat',
  ...
  createCircle: {
    ...
    color_ochre: 'Ochre',
    name_unusable: 'A name needs a letter or two, and at most 40 characters.',
    couldnt_create: "We couldn't make the circle. Try again.",
    youre_offline: "You're offline. Connect, then try again.",
    too_many: "That's a lot of new circles at once. Try again in a while.",
  },
  customWindow: {
    when: 'When?',
    ...
    '14_days_the_most_you_can_ask': '14 days · up to 30 at once',
  ...
  deadlinePassed: {
    ...
    lead: 'Nothing changes until you lock something in. {day} stays possible until it starts.',
    lead_none:
      'Nothing works for enough people yet, and nothing changes until you decide what to do.',
    lock_in: 'Lock in {day}',
    row_label: '{title}. {detail}',
    hand_off_title: 'Hand this to someone else',
    ...
    loading: 'Getting the plan',
    sheet_label: 'Hand this to someone else',
    sheet_title: 'Who should pick the time?',
    sheet_body:
      "They get the plan as it is, with everyone's times. You stay in it like anyone else.",
    sheet_dismiss: 'Keep it',
    loading_members: 'Getting the circle',
    members_failed: "We couldn't load the circle.",
    needs_saved_place: 'Needs a saved place',
    nobody: 'Nobody else in the circle can organise yet: they need a saved place first.',
    confirm_title: 'Hand it to {name}?',
    confirm_body: '{name} picks the time from here, and gets an email saying so.',
    confirm: 'Hand it to {name}',
    handing: 'Handing it over',
    keep: 'Keep it',
    back_to_list: 'Someone else',
    problem_generic: "That didn't work. Try again.",
  ...
  editPlan: {
    ...
    these_dates: 'These dates · {dates}',
    closes_unchanged: '{deadline} · unchanged',
    closes_moved: '{deadline} · moved to match the new dates',
    see_the_plan: 'See the plan',
    replies_close_at: 'Replies close {deadline}',
    save: 'Save changes',
    saving: 'Saving',
    ...
    warn_again_fresh_one:
      'Changing this means {name} will be asked for their times again, and {other} gets a fresh ask. Anything sent for the old times is cleared.',
    warn_again_fresh_many:
      'Changing this means {name} will be asked for their times again, and {other} get a fresh ask. Anything sent for the old times is cleared.',
    warn_fresh_one:
      'Changing this means {other} gets a fresh ask. Nobody has answered yet, so nothing is cleared.',
    warn_fresh_many:
      'Changing this means {other} get a fresh ask. Nobody has answered yet, so nothing is cleared.',
    warn_nobody: "Changing this starts a new question, but nobody's been asked yet.",
    not_yours_title: 'Only the organiser can edit this plan.',
    not_yours_body:
      'It still shows up in the circle, and you can change your own times from the link.',
  ...
  enterCode: {
    ...
    youre_offline: "You're offline. Connect, then try again.",
    reference: 'Ref {reference}',
    didnt_get_it: "Didn't get it? Check spam, or send another.",
    send_another_in: 'Send another in {count}s',
    expired: 'That code has expired. Send a new one.',
    too_many_tries: "That's a lot of tries. Wait a few minutes, then send a new code.",
  ...
  firstCircle: {
    ...
    create_circle: 'Create circle',
    creating: 'Creating',
    name_unusable: 'Give the circle a name of up to 40 characters.',
    too_many_tries: "That's a lot of new circles at once. Wait a little, then try again.",
    couldnt_create: "Something went wrong, so the circle wasn't made. Please try again.",
    youre_offline: "You're offline. Connect, then try again.",
    reference: 'Ref {reference}',
  },
  firstPlan: {
    ...
    too_late_for_tonight:
      "It's got too late for tonight since this opened. Pick this weekend, or the next 14 days.",
    ...
    about_1_hour: 'About an hour',
    about_90_minutes: 'About 90 minutes',
    about_3_hours: 'About 3 hours',
    about_4_hours: 'About 4 hours',
    about_5_hours: 'About 5 hours',
    at_least_of: 'At least {count} of {total} need to make it',
    at_least: 'At least {count} need to make it',
  ...
  /** `/terms` and `/privacy`, linked from Welcome (S1-22). Not artboards. */
  legal: {
    terms_title: 'The terms, briefly',
    terms_who_heading: 'Who it is for',
    terms_who_body:
      '{brand} is for people aged 18 and over, organising time with friends they already know.',
    terms_what_heading: 'What it does',
    terms_what_body:
      'It helps a group find a time. It does not guarantee anyone turns up, and it is not a way to reach people who have not chosen to join your circle.',
    terms_kind_heading: 'Be kind',
    terms_kind_body:
      "Use names your friends would recognise, and don't use a circle to pester, deceive or harass anyone. We can remove a circle or an account that is used that way.",
    terms_beta_heading: 'An early version',
    terms_beta_body:
      'This is a private beta. Things will change, and we will tell you in the app before anything that affects you does.',
    privacy_title: 'Privacy, briefly',
    privacy_keep_heading: 'What we keep',
    privacy_keep_body:
  ...
  noQuorum: {
    headline: "There wasn't enough overlap this time.",
    body_quorum:
      "Nothing in the window works for at least {count} of you. Here's the closest it got.",
    body_required: "{name} has to be there and can't make any of these. Here's the closest it got.",
    what_would_unlock_it: 'What would unlock it',
    lower_title: 'Lower to {count} people',
    lower_body:
      '{day} becomes possible. The plan then keeps {count} as its number, even as the circle grows.',
    lower_body_chosen: '{day} becomes possible.',
    lower_body_plain: 'The closest time becomes possible.',
    required_title: 'Change who has to be there',
    required_body: '{name} is no longer able to make it. Lowering the number would not help.',
    wider_title: 'Try a wider window',
    wider_body: 'Ask about {count} days instead of {total}',
    wider_confirm_title: 'Ask about more days?',
    wider_confirm_body:
      'The plan would run to {day}. It becomes a new question, so everyone who has answered is asked again: {name}.',
    wider_confirm_body_nobody: 'The plan would run to {day}. Nobody has answered yet.',
    wider_confirm: 'Ask again',
    wider_keep: 'Keep it as it is',
    wider_sheet_label: 'Ask about more days',
    widening: 'Asking',
    checking: 'Checking',
    close_title: 'Close this attempt',
    close_body: "The circle just sees it didn't line up",
    confirm_title: 'Close this attempt?',
    confirm_body: 'Everyone is told the plan is off. No reason is given and nobody is named.',
    confirm_close: 'Close it',
    keep_open: 'Keep it open',
    sheet_label: 'Close this attempt',
    dismiss_label: 'Keep it open',
    closing: 'Closing',
    lowering: 'Lowering',
    problem_generic: "That didn't go through. Try again in a moment.",
    problem_not_organiser: 'Only the organiser can change this plan.',
  ...
  notificationSettings: {
    ...
    got_it: 'Got it',
    no_circles:
      "You're not in any circles yet. Once you are, you choose what each one sends you here.",
    loading: 'Getting your settings',
    couldnt_load: "We couldn't load your settings.",
    youre_offline: "You're offline. Connect, then try again.",
    try_again: 'Try again',
    couldnt_save: "That didn't save. Try again.",
  ...
  planSetup: {
    ...
    custom_times: 'Custom',
    band_line: '{time}',
    band_cells: '{count} half hours a day for everyone to look at',
    ...
    from: 'From {time}',
    to: 'Until {time}',
    quorum_of: 'At least {count} of {total} need to make it',
    quorum_at_least: 'At least {count} need to make it',
    quorum_adjusts: 'Adjusts as more people join',
    ...
    earlier: 'Earlier',
    later: 'Later',
    closes_in_minutes: 'Replies close in {count} minutes',
    closes_in_hours: 'Replies close in {count} hours',
    closes_in_days: 'Replies close in {count} days',
    closes_at_sooner: '{deadline} · you can pick sooner',
    closes_at_latest:
      "{deadline} · that's the last time it could start, so replies stay open until then",
    ...
    change: 'Change',
    change_hint: 'Change: {what}',
    required_title: 'Who has to be there',
    required_just_you: 'Just you',
    required_nobody: 'Nobody in particular',
    required_detail: 'They count toward the number above.',
    required_sheet_title: 'Who has to be there?',
    required_sheet_body: 'Only times that work for everyone ticked here are offered.',
    required_sheet_asked: 'Only people this plan is asking can be required.',
    you: 'you',
    you_named: '{name} (you)',
    left_the_circle: '{name} (left the circle)',
    someone: 'Someone',
    done: 'Done',
    deadline_sheet_title: 'When should replies close?',
    deadline_hour: 'In an hour',
    deadline_day: 'In a day',
    deadline_two_days: 'In 2 days',
    deadline_three_days: 'In 3 days',
    deadline_latest: 'At the last possible start',
    deadline_pick: 'Or pick a day and time',
    deadline_latest_note: 'The latest is {deadline}, the last moment the plan could still start.',
    deadline_not_allowed: "That's after the last possible start, or already gone.",
    deadline_earlier: 'Half an hour earlier',
    deadline_later: 'Half an hour later',
    use_this_time: 'Use this time',
    asking: 'Asking',
    problem_too_late_for_tonight:
      "It's too late tonight for a catch-up that long. Try a shorter one, or another day.",
    problem_window_has_passed: 'Those times have already gone. Pick later dates.',
    problem_band_shorter_than_meetup:
      "That's longer than the times of day allow. Pick a shorter catch-up or wider hours.",
    problem_window: "Those dates don't work. Pick them again, up to 30 days.",
    problem_band: "Those times of day don't work. Pick them again.",
    problem_deadline:
      'Replies have to close before the last possible start, and not in the past. Pick another time.',
    problem_pick_dates: 'Pick the dates first.',
    problem_generic: 'Something went wrong, so nothing was changed. Please try again.',
    problem_offline: "You're offline. Connect, then try again.",
    problem_too_many: "That's a lot of tries in a short time. Wait a little, then try again.",
    problem_not_organiser: 'Only the organiser can change this plan.',
    problem_finished: "This plan is over, so it can't be changed.",
    problem_wrong_state:
      "This plan has moved on since you opened it. Go back to see where it's got to.",
    ...
    problem_in_progress: '{circle} is already finding a time. Edit or cancel that plan first.',
    ...
    youre_offline: "You're offline. Connect, then try again.",
    try_again: 'Try again',
    not_found: "This plan isn't one you can see.",
  },
  share: {
  ...
  planShared: {
    ...
    ask_again_edited:
      "The plan changed, so everyone's being asked again. Send the link so they see it.",
  },
  privacy: {
    privacy: 'Privacy',
  ...
  rescheduledGuest: {
    ...
    choose_my_times: 'Choose my times',
    not_this_time: 'Not this time',
    headline_day: '{day} is off the table. New times?',
    headline_plain: 'New times?',
    body_named:
      "{name} reopened the plan. Your earlier times don't carry over, so it's a fresh ask.",
    body_plain: "The plan was reopened. Your earlier times don't carry over, so it's a fresh ask.",
    range: '{from} – {to}',
  },
  saveAccess: {
  ...
  settings: {
    ...
    reset_title: 'Reset the invite link?',
    reset_body: 'The old link stops working straight away. Everyone already in {circle} stays in.',
    new_link_ready: 'New link ready. The old one no longer works.',
    couldnt_reset: "The link didn't reset. Try again.",
    colour: 'Colour',
    cadence_title: 'How often would you like to catch up?',
    cadence_weekly: 'About weekly',
    cadence_fortnightly: 'About fortnightly',
    cadence_monthly: 'About monthly',
    cadence_two_monthly: 'About every two months',
    cadence_none: 'No goal',
    nudge_title: 'Who gets nudged to plan the next one?',
    nudge_hint: 'One person each time, never the whole circle.',
    policy_take_turns: 'Take turns',
    policy_owner: 'The owner',
    policy_last_organiser: 'Whoever planned the last one',
    off: 'Off',
    ...
    remove_body:
      '{name} stops seeing {circle} straight away. Their times for plans still asking are deleted.',
    couldnt_remove: "{name} wasn't removed. Try again.",
    archive_title: 'Archive {circle}?',
    archive_body:
      'It stops every prompt and moves to the bottom of your circles. Nothing is deleted, and you can bring it back.',
    archive: 'Archive',
    bring_back: 'Bring this circle back',
    only_the_owner: 'Only {owner} can change these.',
    couldnt_save: "That didn't save. Try again.",
    loading: 'Getting the circle',
    couldnt_load: "We couldn't load this circle.",
    youre_offline: "You're offline. Connect, then try again.",
    try_again: 'Try again',
  },
  ...
  signIn: {
    ...
    too_many_tries: "That's a lot of codes for one address. Wait a few minutes, then try again.",
    youre_offline: "You're offline. Connect, then try again.",
  },
  sparkExpired: {
    brand: '{brand}',
  ...
  timeZone: {
    choose_your_time_zone: 'Choose your time zone',
    times_in_plans_show_in_it: 'Times in your plans show in this zone.',
    search: 'Search time zones',
    search_placeholder: 'City or region',
    no_match: 'No time zone matches that. Try a nearby city.',
  },
  volunteer: {
    sunday_crew: 'Sunday Crew',
    started_quietly: 'Started quietly',
  ...
  waiting: {
    ...
    still_one: 'Still to answer: {name}.',
    still_two: 'Still to answer: {name} and {other}.',
    still_three: 'Still to answer: {name}, {other} and {third}.',
    still_many: 'Still to answer: {name}, {other} and {count} others.',
    still_none: 'Everyone has answered. The options are being worked out.',
    only_you:
  ...
  yourName: {
    ...
    filled_in_from_your_apple_account_change:
    ...
    change: 'Change',
    change_time_zone: 'Choose a different time zone',
    thats_all_we_need_no_photo_no: "That's all we need. No photo, no phone number, no contacts.",
    continue: 'Continue',
    saving: 'Saving',
    loading: 'Getting things ready',
    couldnt_load: "We couldn't load your details.",
    try_again: 'Try again',
    youre_offline: "You're offline. Connect, then try again.",
    name_unusable: 'Add a name of up to 40 characters.',
    couldnt_save: "Something went wrong, so your name wasn't saved. Please try again.",
    reference: 'Ref {reference}',
  },
} as const;
