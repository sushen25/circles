...
_Status: accepted · Date: 19 September 2026 · numbered when rebased onto main (SUS-82 takes 0024) · its open question on organiser email is answered by [ADR 00XX](./00XX-an-organiser-turns-organiser-email-off-in-the-app.md)_
...
- **How an organiser stops organiser email is still open.** Today it is
  ...
  founder's call. _Answered by ADR 00XX: a switch in the app, on notification
